...
const words = ["Insider", "Software Engineer", "Data Analyst", "Accountant","HR", "Alumni", "Cloud Architect", "Cloud Architect", "Proffessor", "Chartered Accountant", "Investment Banker", "& Others"];
let index = 0;
